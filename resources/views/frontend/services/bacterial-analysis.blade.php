...
@section('title', 'Bacterial Analysis')

@section('content')
<x-frontend.page-title
    title="Bacterial Analysis"
    :breadcrumbs="[['title' => 'Bacterial Analysis']]"
/>
								...
								<aside class="widget post-list">
									...
									<div class="all-post-list">
										<ul>
											...
											<li class="post-active"><a href="{{ route('services.show', 'bacterial-analysis') }}"> Bacterial Analysis </a></li>
