...
@section('title', 'Cataract Surgery')

@section('content')
<x-frontend.page-title
    title="Cataract Surgery"
    :breadcrumbs="[['title' => 'Cataract Surgery']]"
/>
							...
							<aside class="service-sidebar">
								<aside class="widget post-list">
									...
									<div class="all-post-list">
										<ul>
											<li class="post-active"><a href="{{ route('services.show', 'service-slug') }}"> Cataract Surgery </a></li>
											<li><a href="{{ route('services.show', 'service-slug') }}"> Ocular Oncology </a></li>
											<li><a href="{{ route('services.show', 'service-slug') }}"> Myopia Control </a></li>
											<li><a href="{{ route('services.show', 'service-slug') }}"> Blink Point </a></li>
											<li><a href="{{ route('services.show', 'service-slug') }}"> Oculoplasty </a></li>
											<li><a href="{{ route('services.show', 'service-slug') }}"> Cornea </a></li>
											<li><a href="{{ route('services.show', 'service-slug') }}"> Vitreoretinal </a></li>
											<li><a href="{{ route('services.show', 'service-slug') }}"> Glaucoma </a></li>
											<li><a href="{{ route('services.show', 'service-slug') }}"> Cataract & Refractive </a></li>
										</ul>
									</div>
								</aside>
