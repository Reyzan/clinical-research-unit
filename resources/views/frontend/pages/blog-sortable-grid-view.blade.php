...
<head>
    ...
    <title>Blog Sortable Grid View – Ophtical HTML Template</title>
				...
				<div class="container">
					<div class="pbmit-sortable-list">
						<ul class="pbmit-sortable-list-ul">
						   ...
						   <li><a href="#" class="pbmit-sortable-link" data-sortby="contact-lens">Contact Lens</a></li>
						   <li><a href="#" class="pbmit-sortable-link" data-sortby="eye-care">Eye Care</a></li>
						   <li><a href="#" class="pbmit-sortable-link" data-sortby="eye-treatment">Eye Treatment</a></li>
						   <li><a href="#" class="pbmit-sortable-link" data-sortby="glaucoma">Glaucoma</a></li>
						   <li><a href="#" class="pbmit-sortable-link" data-sortby="insight">Insight</a></li>
						</ul>
					</div>
					<div class="row pbmit-element-posts-wrapper">
						<article class="pbmit-blog-style-1 col-md-6 col-lg-4 eye-treatment">
							<div class="post-item">
						...
						<article class="pbmit-blog-style-1 col-md-6 col-lg-4 contact-lens">
							<div class="post-item">
								<div class="pbminfotech-box-content">
									<div class="pbmit-featured-container">
										<div class="pbmit-meta-category-wrapper pbmit-meta-line">
						...
						<article class="pbmit-blog-style-1 col-md-6 col-lg-4 insight">
							<div class="post-item">
								<div class="pbminfotech-box-content">
									<div class="pbmit-featured-container">
										<div class="pbmit-meta-category-wrapper pbmit-meta-line">
						...
						<article class="pbmit-blog-style-1 col-md-6 col-lg-4 glaucoma">
							<div class="post-item">
								<div class="pbminfotech-box-content">
									<div class="pbmit-featured-container">
										<div class="pbmit-meta-category-wrapper pbmit-meta-line">
								...
								<div class="pbminfotech-box-content">
									<div class="pbmit-featured-container">
										...
										<div class="pbmit-featured-container-inner">
											<div class="pbmit-featured-img-wrapper">
												<div class="pbmit-featured-wrapper">
													<img src="{{ asset('Ophtical HTML Files/images/blog/blog-img-07b.jpg') }}" class="img-fluid" alt="">
												</div>
											</div>
											<a class="pbmit-link" href="blog-single-detail.html" title="Go to Signs you should see an eye doctor immediately"></a>
										</div>
									</div>
									<div class="pbmit-content-wrapper">
										<div class="pbmit-meta-wraper-inner">
								...
								<div class="pbminfotech-box-content">
									<div class="pbmit-featured-container">
										...
										<div class="pbmit-featured-container-inner">
											<div class="pbmit-featured-img-wrapper">
												<div class="pbmit-featured-wrapper">
													<img src="{{ asset('Ophtical HTML Files/images/blog/blog-img-08.webp') }}" class="img-fluid" alt="">
												</div>
											</div>
											<a class="pbmit-link" href="blog-single-detail.html" title="Go to Preparing for your LASIK consultation: what to expect"></a>
										</div>
									</div>
									<div class="pbmit-content-wrapper">
										<div class="pbmit-meta-wraper-inner">
						...
						<article class="pbmit-blog-style-1 col-md-6 col-lg-4 eye-care">
							<div class="post-item">
								<div class="pbminfotech-box-content">
									<div class="pbmit-featured-container">
										<div class="pbmit-meta-category-wrapper pbmit-meta-line">
										...
										<div class="pbmit-featured-container-inner">
											<div class="pbmit-featured-img-wrapper">
												<div class="pbmit-featured-wrapper">
													<img src="{{ asset('Ophtical HTML Files/images/blog/blog-img-09b.jpg') }}" class="img-fluid" alt="">
												</div>
											</div>
											<a class="pbmit-link" href="blog-single-detail.html" title="Go to How nutrition can improve your vision and eye health"></a>
										</div>
									</div>
									<div class="pbmit-content-wrapper">
										<div class="pbmit-meta-wraper-inner">
