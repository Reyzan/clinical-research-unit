...
<html class="no-js" lang="en">
   <head>
      ...
      <title>Our Doctors – Ophtical HTML Template</title>
					...
					<div class="pbmit-title-bar-content-inner">
						<div class="pbmit-tbar">
							<div class="pbmit-tbar-inner">
								<h1 class="pbmit-tbar-title">Our Doctors</h1>
							</div>
						</div>
						<div class="pbmit-breadcrumb">
							<div class="pbmit-breadcrumb-inner">
								...
								<span><span class="post-root post post-post current-item">Our Doctors</span></span>
							</div>
						</div>
					</div>
				</div> 
								...
								<div class="pbmit-featured-inner">
									<div class="pbmit-featured-img-wrapper">
										<div class="pbmit-featured-wrapper">
											<img src="{{ asset('Ophtical HTML Files/images/team/team-01.jpg') }}" class="img-fluid" alt="">
										</div>
									</div>
						...
						<article class="pbmit-team-style-1 col-md-6 col-lg-4">
							<div class="pbminfotech-post-item">
								<div class="pbmit-featured-inner">
									<div class="pbmit-featured-img-wrapper">
										<div class="pbmit-featured-wrapper">
											<img src="{{ asset('Ophtical HTML Files/images/team/team-02.jpg') }}" class="img-fluid" alt="">
										</div>
									</div>
						...
						<article class="pbmit-team-style-1 col-md-6 col-lg-4">
							<div class="pbminfotech-post-item">
								<div class="pbmit-featured-inner">
									<div class="pbmit-featured-img-wrapper">
										<div class="pbmit-featured-wrapper">
											<img src="{{ asset('Ophtical HTML Files/images/team/team-03.jpg') }}" class="img-fluid" alt="">
										</div>
									</div>
						...
						<article class="pbmit-team-style-1 col-md-6 col-lg-4">
							<div class="pbminfotech-post-item">
								<div class="pbmit-featured-inner">
									<div class="pbmit-featured-img-wrapper">
										<div class="pbmit-featured-wrapper">
											<img src="{{ asset('Ophtical HTML Files/images/team/team-04.jpg') }}" class="img-fluid" alt="">
										</div>
									</div>
						...
						<article class="pbmit-team-style-1 col-md-6 col-lg-4">
							<div class="pbminfotech-post-item">
								<div class="pbmit-featured-inner">
									<div class="pbmit-featured-img-wrapper">
										<div class="pbmit-featured-wrapper">
											<img src="{{ asset('Ophtical HTML Files/images/team/team-05.jpg') }}" class="img-fluid" alt="">
										</div>
									</div>
						...
						<article class="pbmit-team-style-1 col-md-6 col-lg-4">
							<div class="pbminfotech-post-item">
								<div class="pbmit-featured-inner">
									<div class="pbmit-featured-img-wrapper">
										<div class="pbmit-featured-wrapper">
											<img src="{{ asset('Ophtical HTML Files/images/team/team-06.jpg') }}" class="img-fluid" alt="">
										</div>
									</div>
