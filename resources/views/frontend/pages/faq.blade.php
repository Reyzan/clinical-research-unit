...
<html class="no-js" lang="en">
   <head>
      ...
      <title>Faq – Ophtical HTML Template</title>
   ...
   <body>
    <!-- Page Wrapper -->
    <div class="page-wrapper faq-page" id="page">
											...
											<div class="pbmit-ihbox-box">
												<div class="pbmit-ihbox-icon">
													<div class="pbmit-ihbox-icon-wrapper pbmit-ihbox-icon-type-image">
														<img src="{{ asset('Ophtical HTML Files/images/demo-3/aword/aword-img-01.png') }}" alt="">
													</div>
												</div>
												<div class="pbmit-ihbox-contents">
													<h2 class="pbmit-element-title">
									...
									<article class="pbmit-miconheading-style-3 col-md-6 col-lg-4">
										<div class="pbmit-ihbox-style-3">
											<div class="pbmit-ihbox-box">
												<div class="pbmit-ihbox-icon">
													<div class="pbmit-ihbox-icon-wrapper pbmit-ihbox-icon-type-image">
														<img src="{{ asset('Ophtical HTML Files/images/demo-3/aword/aword-img-02.png') }}" alt="">
													</div>
												</div>
												<div class="pbmit-ihbox-contents">
													<h2 class="pbmit-element-title">
									...
									<article class="pbmit-miconheading-style-3 col-md-6 col-lg-4">
										<div class="pbmit-ihbox-style-3">
											<div class="pbmit-ihbox-box">
												<div class="pbmit-ihbox-icon">
													<div class="pbmit-ihbox-icon-wrapper pbmit-ihbox-icon-type-image">
														<img src="{{ asset('Ophtical HTML Files/images/demo-3/aword/aword-img-03.png') }}" alt="">
													</div>
												</div>
												<div class="pbmit-ihbox-contents">
													<h2 class="pbmit-element-title">
											...
											<div class="pbmit-featured-container-inner">
												...
												<div class="pbmit-featured-img-wrapper">
													<div class="pbmit-featured-wrapper">
														<img src="{{ asset('Ophtical HTML Files/images/demo-1/blog/blog-img-01.jpg') }}" class="img-fluid" alt="">
													</div>
												</div>
										...
										<div class="pbminfotech-box-content">
											<div class="pbmit-featured-container">
												<div class="pbmit-featured-container-inner">
													...
													<div class="pbmit-featured-img-wrapper">
														<div class="pbmit-featured-wrapper">
															<img src="{{ asset('Ophtical HTML Files/images/demo-1/blog/blog-img-02.jpg') }}" class="img-fluid" alt="">
														</div>
													</div>
										...
										<div class="pbminfotech-box-content">
											<div class="pbmit-featured-container">
												<div class="pbmit-featured-container-inner">
													...
													<div class="pbmit-featured-img-wrapper">
														<div class="pbmit-featured-wrapper">
															<img src="{{ asset('Ophtical HTML Files/images/demo-1/blog/blog-img-03.jpg') }}" class="img-fluid" alt="">
														</div>
													</div>
										...
										<div class="pbminfotech-box-content">
											<div class="pbmit-featured-container">
												<div class="pbmit-featured-container-inner">
													...
													<div class="pbmit-featured-img-wrapper">
														<div class="pbmit-featured-wrapper">
															<img src="{{ asset('Ophtical HTML Files/images/demo-1/blog/blog-img-04.jpg') }}" class="img-fluid" alt="">
														</div>
													</div>
